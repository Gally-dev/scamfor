...
export const data = [
  ...
  "štruktúra poskytovateľa javí znaky MLM (multi-level marketingu) a odmeňovanie za používanie služby čiastočne závisí od schopností vytvorenia vlastnej predajnej siete",
  "ponuky na poskytnutie služby alebo investovanie prostredníctvom nevyžiadanej e-mailovej komunikácie, prostredníctvom sociálnych sietí, prípadne nevyžiadaných telefonických hovorov",
  "marketingová komunikácia založená na využívaní botov",
  ...
  "prevádzkovanie trading, signálových alebo Pump & Dump komunitných skupín (telegram, discord...)",
